...
>
>`Parameterized constructors` are constructors that have parameters and a reference to the instance being created called `self`. The self reference serves as the first arg..
>```python
>class Details:
